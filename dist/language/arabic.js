...
exports.isArabicStopWord = isArabicStopWord;
exports.getArabicStopWords = getArabicStopWords;
/**
 * Arabic stop words
 */
 ...
 */
function tokenizeAr(text, options = {}) {
    ...
    const tokens = text
        ...
        if (w.length < minLength)
            return false;
        if (removeStopWords && ARABIC_STOP_WORDS.has(w))
            return false;
        return true;
    });
 ...
 */
function isArabicStopWord(word) {
